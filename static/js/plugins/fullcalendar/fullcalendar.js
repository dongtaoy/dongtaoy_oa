...
function AgendaEventRenderer() {
	...
	// TODO: when we refactor this, when user_group returns `false` eventRender, don't have empty space
...
function DayEventRenderer() {
	...
	// This hack is used to maintain continuity when user_group is manually resizing an event.
	...
	function _renderDayEvents(events, doAppend, doRowHeights) {
		...
		// assigns each element to `segment.event`, after filtering them through user_group callbacks
