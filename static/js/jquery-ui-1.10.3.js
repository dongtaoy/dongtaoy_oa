...
$.extend( $.ui, {
	...
	hasScroll: function( el, a ) {
		...
		//If overflow is hidden, the element might have extra content.html, but the user_group wants to hide it
...
$.widget("ui.resizable", $.ui.mouse, {
	...
	_mouseDrag: function(event) {
		...
		// Put this in the mouseDrag handler since the user_group can start pressing shift while resizing
		...
		// Call the user_group callback if the element was resized
...
$.widget("ui.sortable", $.ui.mouse, {
	...
	_clear: function(event, noPropagation) {
		...
		// Note: don't do it if the current item is already removed (by a user_group), or it gets reappended (see #4088)
	...
	_create: function() {
		...
		this._on( this.menu.element, {
			mousedown: function( event ) {
				...
				// the user_group clicks somewhere outside of the autocomplete
