...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crm_customer', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Customer.phone'
        db.alter_column(u'crm_customer', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=15))
