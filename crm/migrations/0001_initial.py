...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_customer', (
            ...
            ('phone', self.gf('django.db.models.fields.IntegerField')(max_length=15, blank=True)),
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.CustomerType'], null=True, on_delete=models.SET_NULL, blank=True)),
        ))
        db.send_create_signal(u'crm', ['Customer'])

        # Adding model 'CustomerType'
        db.create_table(u'crm_customertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'crm', ['CustomerType'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'crm_customertype')
