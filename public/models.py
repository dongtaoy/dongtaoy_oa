...
class Message(models.Model):
    ...
    fromUser = models.ForeignKey('hr.User', blank=True, null=True, on_delete=models.SET_NULL, related_name='Message_fromUser')
    toUser = models.ManyToManyField('hr.User', through='MessageTo', blank=True, null=True, related_name='Message_toUser')
...
class MessageTo(models.Model):
    ...
    user = models.ForeignKey('hr.User', null=True, blank=True, on_delete=models.SET_NULL)
