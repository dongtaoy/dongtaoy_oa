...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Department.leader'
        db.add_column(u'hr_department', 'leader',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hr.Employee'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Department.leader'
        db.delete_column(u'hr_department', 'leader_id')
    ...
    models = {
        ...
        u'hr.department': {
            ...
            'leader': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hr.Employee']", 'null': 'True', 'blank': 'True'}),
