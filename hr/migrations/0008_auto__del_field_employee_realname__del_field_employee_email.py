...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Employee.realname'
        db.delete_column(u'hr_employee', 'realname')

        # Deleting field 'Employee.email'
        db.delete_column(u'hr_employee', 'email')


    def backwards(self, orm):
        # Adding field 'Employee.realname'
        db.add_column(u'hr_employee', 'realname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45, blank=True),
                      keep_default=False)

        # Adding field 'Employee.email'
        db.add_column(u'hr_employee', 'email',
