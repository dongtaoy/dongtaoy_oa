...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Userstatus.label' to match new field type.
        db.rename_column(u'hr_userstatus', 'label', 'label_id')
        # Changing field 'Userstatus.label'
        db.alter_column(u'hr_userstatus', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Label']))
        # Adding index on 'Userstatus', fields ['label']
        db.create_index(u'hr_userstatus', ['label_id'])


    def backwards(self, orm):
        # Removing index on 'Userstatus', fields ['label']
        db.delete_index(u'hr_userstatus', ['label_id'])


        # Renaming column for 'Userstatus.label' to match new field type.
        db.rename_column(u'hr_userstatus', 'label_id', 'label')
        # Changing field 'Userstatus.label'
        db.alter_column(u'hr_userstatus', 'label', self.gf('django.db.models.fields.CharField')(max_length=45))
    ...
    models = {
        ...
        u'hr.userstatus': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['system.Label']", 'blank': 'True'}),
