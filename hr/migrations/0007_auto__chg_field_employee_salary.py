...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employee.salary'
        db.alter_column(u'hr_employee', 'salary', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Employee.salary'
        db.alter_column(u'hr_employee', 'salary', self.gf('django.db.models.fields.FloatField')(null=True))
