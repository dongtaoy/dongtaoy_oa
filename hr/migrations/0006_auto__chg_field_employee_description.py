...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employee.description'
        db.alter_column(u'hr_employee', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Employee.description'
        db.alter_column(u'hr_employee', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
