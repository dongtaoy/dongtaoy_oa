...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Group.label' to match new field type.
        db.rename_column(u'hr_group', 'label', 'label_id')
        # Changing field 'Group.label'
        db.alter_column(u'hr_group', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Label'], null=True))
        # Adding index on 'Group', fields ['label']
        db.create_index(u'hr_group', ['label_id'])


    def backwards(self, orm):
        # Removing index on 'Group', fields ['label']
        db.delete_index(u'hr_group', ['label_id'])


        # Renaming column for 'Group.label' to match new field type.
        db.rename_column(u'hr_group', 'label_id', 'label')
        # Changing field 'Group.label'
        db.alter_column(u'hr_group', 'label', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
