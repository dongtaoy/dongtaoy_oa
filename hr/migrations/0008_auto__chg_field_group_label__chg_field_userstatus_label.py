...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hr_group', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Label'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Userstatus.label'
        db.alter_column(u'hr_userstatus', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Label'], null=True, on_delete=models.SET_NULL))
