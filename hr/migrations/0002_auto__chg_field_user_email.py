...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hr_user', 'email', self.gf('django.db.models.fields.CharField')(max_length=101))

    def backwards(self, orm):

        # Changing field 'User.email'
        db.alter_column(u'hr_user', 'email', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'hr.user': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '101', 'blank': 'True'}),
