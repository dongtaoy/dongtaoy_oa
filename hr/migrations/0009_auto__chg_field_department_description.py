...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hr_department', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Department.description'
        db.alter_column(u'hr_department', 'description', self.gf('django.db.models.fields.TextField')(default=None))
